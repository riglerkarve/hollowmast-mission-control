...
<!--COUNTS-->
<!-- Generated by tools/stamp-claude-md.cjs. Do not hand-edit: run the tool. Last: 2026-08-19 -->

| Counted | |
| --- | --- |
| Route files | 30 |
| Endpoints | 172 |
| Panels in the registry | 20 |
| Migrated modules | 29 |
| Tables | 60 |
| Commits | 144, remote: none |
| Panels defining their own api() | 15 |
| Memory store | 207 files |

**Migrated modules**, from `schema_meta`: alerts · analytics · atlas · board · brain · briefing · browsing · budget · cash · drive · exercise · finance · gate · goals · health · income · income-attribution · income-balances · lifestyle · mail · runlog · safety · schedule · sessions · tasks · team · todo · wellbeing · work

**Tables**, from `sqlite_master`: alert_events · alert_kinds · analytics_probes · analytics_traffic · atlas_countries · board_imports · board_items · brain_flags · brain_notes · briefings · browsing_domains · budget_lines · cash_counts · data_access_log · drive_files · drive_sync · exercise_sessions · finance_accounts · finance_assets · finance_rules · finance_transactions · focus_sessions · gate_attempts · gate_devices · gmail_messages · gmail_sender_rules · gmail_senders · gmail_sync · goal_steps · goals · health_metrics · income_balances · income_entries · income_stream_payers · income_streams · lifestyle_chores · lifestyle_done · lifestyle_foods · lifestyle_intake · lifestyle_meals · lifestyle_targets · safety_decisions · safety_limits · safety_payees · schedule_events · schema_meta · sqlite_sequence · tasks · team_assignments · team_handovers · team_plans · team_sessions · team_steering · todo_items · todo_notes · tool_runs · wellbeing_entries · wellbeing_quiet · wishlist_items · work_items
